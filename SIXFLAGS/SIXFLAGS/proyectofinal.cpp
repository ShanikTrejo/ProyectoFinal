...
//////////////////////////////////////////////////////////
			glPushMatrix(); //Casa01
				glTranslatef(4.0,3.0,-7.0);
				glScalef(1.0,2.0,6);//ancho
				glDisable(GL_LIGHTING);
				fig5.prisma2(text6.GLindex, 0);
				glEnable(GL_LIGHTING);

				glPushMatrix();
				glTranslatef(1, 0, 0); // muevo mis cordenandas ya no es el 0.0 -2.5,1.25
				glRotatef(90, 0, 0, 1);

			glPushMatrix(); //Casa01
                        glTranslatef(0,0, 0.0);//arriba,izqui,profu
						glRotatef(90, 1, 0, 0);
						//glScalef(2, 1.0, 1);
						glDisable(GL_LIGHTING);
						fig5.prisma2(text6.GLindex, 0);
			 ...
			 glPushMatrix(); //Casa01
			 //glRotatef(90, 0, 1, 0);
			 glTranslatef(20, 0, 0.0);//arriba,izqui,profu
			 glRotatef(90, 0, 0, 1);
			 //glScalef(2, 1.0, 1);
			 glDisable(GL_LIGHTING);
			 fig5.prisma2(text6.GLindex, 0);
